...
// Request DTO for searching and filtering attendance records with pagination.
public record AttendanceSearchRequest
{
    // Optional keyword to search by member name (max 256 characters).
    [MaxLength(256)]
    ...
    // Optional lower bound for attendance date filter.
    public DateTime? DateFrom { get; init; }

    // Optional upper bound for attendance date filter.
