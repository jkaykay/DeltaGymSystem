...
namespace GymSystem.Web.Services
{
    public interface ITrainerApiService
    {
        ...
        Task<TrainerPagedResult<SessionDTO>> GetSessionsAsync(string instructorId, int page, int pageSize, string token, CancellationToken cancellationToken = default);
